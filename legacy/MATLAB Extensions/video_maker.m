...
videoFilePath = 'C:\Users\EMINENT\Downloads\Video\mouse-1-2.mp4';

videoObj = VideoReader(videoFilePath);

outputFolder = 'F:\DLC\mouse_frames';
...
while hasFrame(videoObj)
    ...
    outputFileName = sprintf('frame%d.png', frameNumber);
    imwrite(frame, fullfile(outputFolder, outputFileName));
    frameNumber = frameNumber + 1;
end

disp('Frames saved successfully!');
